...
locations using only the datasets currently available in the workbook:
...
def add_marker_legend(folium_map):
    ...
    """
    legend_html = """
    <div style="position: fixed; bottom: 28px; left: 28px; z-index: 9999; background: rgba(255,255,255,0.94); border: 1px solid #D1D5DB; border-radius: 14px; padding: 14px 16px; width: 355px; box-shadow: 0 6px 18px rgba(0,0,0,0.18); font-family: Arial, sans-serif; color: #111827;">
...
with tab_overview:
    ...
    st.markdown(
        ...
        <div class="success-box">
            ...
            <b>Water source:</b> {escape_text(water_source_note)}
        </div>
        """,
        unsafe_allow_html=True
    )
...
with tab_map:
    ...
    st.markdown(
        """
        The map shows the fertilizer / ammonia production plant locations, renewable resource locations and water assets used in the scoring.
